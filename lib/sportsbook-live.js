...
async function collectEvent(eventPath, opts = {}) {
  const requestStart = Date.now();
  let html = null, err = null;
  try { html = await O.fetchText(`https://www.bestfightodds.com${eventPath}`); }
...
module.exports = {
  collectEvent, consensusFor, checkSynchronisation, movementContext, detectMirrors,
