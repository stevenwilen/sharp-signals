...
function formatTelegram(r) {
  ...
  p(`observations ${R.observationsCreated} · creative ${R.creativeSpeculative} · strong ${R.strongSpeculative} · exploration ${R.exploration} · watch-exp ${R.watchExperiments} · unconfirmed ${R.unconfirmedCandidates}`);
