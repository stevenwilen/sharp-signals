...
async function resolveHistorical(pred) {
  ...
  return {
    ...pred, marketTicker: null, fightTime: win.date,
    priceAtCall: line.prob, result: win.result, priceSource: "bfo", oddsOverround: line.overround,
  };
}
