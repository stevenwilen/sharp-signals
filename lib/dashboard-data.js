...
const BK = require("./bankrolls");   // canonical real-bankroll summary (Real Entertainment)
...
function buildUnifiedDashboard(cardDate) {
  ...
  return {
    ...
    decisionSummary,
    exposure,
    // CANONICAL real-bankroll summary — the SAME object the Sharp Signals app consumes (data/bankrolls.json),
    // so both boards show the identical Real Entertainment ($100) total. Neither recomputes money
    // independently. The manualBankroll block below is the detailed per-status view.
