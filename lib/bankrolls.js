// CANONICAL BANKROLLS SUMMARY — the SINGLE source of truth both dashboards read for current real money.
// It calls the real ledger module's own summary() and writes data/bankrolls.json. The production board
// (public/unified.html via dashboard-data.js) and the Sharp Signals app both consume THIS file; neither
// recomputes money independently, so their totals can never diverge.
//
